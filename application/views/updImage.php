						...
						<div class="col-lg-6">
							<div class="cmp-info">
								<div class="cm-logo">
									...
									<p style="color: blue">You can Update your Article Image here</p>
									<p style="color: blue">When you Update Article Image you will be able to see that in Article</p>
										
									<h1>
										<a href="<?php echo site_url('Article')?>" style="margin: 150px" class="btn btn-danger">Back</a>
									</h1>
								</div><!--cm-logo end-->	
								...
								<div class="sign_in_sec current" id="tab-1">
									...
									<div class="signup-tab">
										...
										<ul>
											...
											<p style="color: red">Article Iamge Update Form</p>
										</ul>
									</div><!--signup-tab end-->	
									<div class="dff-tab current" id="tab-3">
										<form method="post" enctype="multipart/form-data" action="<?php echo site_url('Article/editImage/'.$ArticleId."/".$ImageURL)?>" >
											<div class="row">
												<!-- <div class="col-lg-12 no-pdd">
													<div class="sn-field">
														<input type="text" name="txtTitle" placeholder="Ente Name of Article" required="" value="<?php echo $Article[0]->Title?>">
												...
												<!-- <div class="col-lg-12 no-pdd">
													<div class="sn-field">
														<input type="text" name="txtDesc" placeholder="Enter Description" required="" value="<?php echo $Article[0]->Description?>">
