						...
						<div class="col-lg-6">
							<div class="cmp-info">
								<div class="cm-logo">
									...
									<p style="color: blue">You can Add Image in your Article here</p>
									<p style="color: blue">When you Add Article Image you will look that Image in that Article</p>
								...
								<div class="sign_in_sec current" id="tab-1">
									...
									<div class="signup-tab">
										...
										<ul>
											...
											<p style="color: red">Article Image Add Form</p>
										</ul>
									</div><!--signup-tab end-->	
									<div class="dff-tab current" id="tab-3">
										<form method="post" enctype="multipart/form-data" action="<?php echo site_url('Article/AddArticleImages/'.$ArticleId)?>" >
											<div class="row">
