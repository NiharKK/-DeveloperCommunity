						...
						<div class="col-lg-6">
							<div class="cmp-info">
								<div class="cm-logo">
									...
									<p style="color: blue">You can Update your Article here</p>
									<p style="color: blue">When you Update Article you will add more images to that Article</p>
								...
								<div class="sign_in_sec current" id="tab-1">
									...
									<div class="signup-tab">
										...
										<ul>
											...
											<p style="color: red">Article Create Form</p>
										</ul>
									</div><!--signup-tab end-->	
									<div class="dff-tab current" id="tab-3">
										<form method="post" enctype="multipart/form-data" action="<?php echo site_url('Article/editArticle/'.$Article[0]->ArticleId)?>" >
											<div class="row">
