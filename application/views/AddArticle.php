				...
				<div class="signin-pop">
					<div class="row">
						<div class="col-lg-6">
							<div class="cmp-info">
								<div class="cm-logo">
									<!-- <img src="<?php echo base_url('resources/user/images/cm-logo.png')?>" alt=""> -->
									...
									<p style="color: blue">You can create your Article here</p>
									<p style="color: blue">When you create Article you will add more images to that Article</p>
										
									<h1>
										<a href="<?php echo site_url('Article')?>" style="margin: 150px" class="btn btn-danger">Back</a>
									</h1>
								</div><!--cm-logo end-->	
								<img src="<?php echo base_url('resources/user/images/cm-main-img.png')?>" alt="">			
							</div><!--cmp-info end-->
						</div>
						<div class="col-lg-6">
							<div class="login-sec">
								...
								<div class="sign_in_sec current" id="tab-1">
									...
									<div class="dff-tab current" id="tab-3">
										<form method="post" enctype="multipart/form-data" action="<?php echo site_url('Article/addArticle')?>" >
											<div class="row">
												<div class="col-lg-12 no-pdd">
													<div class="sn-field">
														<input type="text" name="txtTitle" placeholder="Ente Name of Article" required="">
