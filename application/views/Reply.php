							...
							<div class="col-lg-8">
								<div class="main-ws-sec">
									<div class="posts-section">
										<form method="post" action="<?php echo site_url('Community/addCommQuesAns/'.$CommunityQuestionId."/".$CommunityId); ?>">
												<div class="post-bar">
													...
													<div class="epi-sec">
														<ul class="descp">
															<input type="text" name="txtCQID" hidden="" value="<?php echo $CommunityQuestionId ?>">
														</ul>
														<ul class="descp">
														...
														<ul class="descp">
															Answer:
															<textarea name="txtAnswer" title="Enter Answer" required="">
															</textarea>
														</ul>
													...
													<div class="job-status-bar">
														<ul class="like-com">
															<input type="submit" name="AddQuestion" class="btn btn-danger" value="Answer">
														</ul>
													</div>
